local function _1_(...)
  ...
  local function _6_()
    ...
    vim.api.nvim_set_hl(0, "@markup.heading.1.markdown", {fg = "#e86671", bold = true})
    vim.api.nvim_set_hl(0, "@markup.heading.1.marker.markdown", {fg = "#e86671", bold = true})
    vim.api.nvim_set_hl(0, "markdownH2", {fg = "#c678dd", bold = true})
    vim.api.nvim_set_hl(0, "@markup.heading.2.markdown", {fg = "#c678dd", bold = true})
    vim.api.nvim_set_hl(0, "@markup.heading.2.marker.markdown", {fg = "#c678dd", bold = true})
    vim.api.nvim_set_hl(0, "markdownH3", {fg = "#d19a66", bold = true})
    vim.api.nvim_set_hl(0, "@markup.heading.3.markdown", {fg = "#d19a66", bold = true})
    vim.api.nvim_set_hl(0, "@markup.heading.3.marker.markdown", {fg = "#d19a66", bold = true})
    vim.api.nvim_set_hl(0, "markdownH4", {fg = "#e86671", bold = true})
    vim.api.nvim_set_hl(0, "@markup.heading.4.markdown", {fg = "#e86671", bold = true})
    vim.api.nvim_set_hl(0, "@markup.heading.4.marker.markdown", {fg = "#e86671", bold = true})
    vim.api.nvim_set_hl(0, "markdownH5", {fg = "#c678dd", bold = true})
    vim.api.nvim_set_hl(0, "@markup.heading.5.markdown", {fg = "#c678dd", bold = true})
    vim.api.nvim_set_hl(0, "@markup.heading.5.marker.markdown", {fg = "#c678dd", bold = true})
    vim.api.nvim_set_hl(0, "markdownH6", {fg = "#d19a66", bold = true})
    vim.api.nvim_set_hl(0, "@markup.heading.6.markdown", {fg = "#d19a66", bold = true})
    vim.api.nvim_set_hl(0, "@markup.heading.6.marker.markdown", {fg = "#d19a66", bold = true})
