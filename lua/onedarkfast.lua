local function _1_(...)
  ...
  local function _5_()
    ...
    vim.api.nvim_set_hl(0, "DiagnosticVirtualTextError", {bg = 3373646, fg = "#993939"})
    vim.api.nvim_set_hl(0, "DiagnosticVirtualTextWarn", {bg = 3335550, fg = "#93691d"})
    vim.api.nvim_set_hl(0, "DiagnosticVirtualTextInfo", {bg = 2654138, fg = "#2b6f77"})
    vim.api.nvim_set_hl(0, "DiagnosticVirtualTextHint", {bg = 3275506, fg = "#8a3fa0"})
